...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun loadFonts() {
        // Get the TextViews from the layout hierarchy
        val notificationTitle = binding.root.findViewById<TextView>(R.id.notificationsSwitch)
        val notificationTimeText = binding.notificationTimeText
        val currentStreakText = binding.currentStreakText
        val resetStreakButton = binding.resetStreakButton
        val aboutButton = binding.aboutButton
        
        // Load fonts for all TextViews asynchronously
        FontLoader.loadFontAsync(lifecycleScope, this, notificationTitle, R.font.poppins_medium)
        FontLoader.loadFontAsync(lifecycleScope, this, notificationTimeText, R.font.poppins_light)
        FontLoader.loadFontAsync(lifecycleScope, this, currentStreakText, R.font.poppins_regular)
        FontLoader.loadFontAsync(lifecycleScope, this, resetStreakButton, R.font.poppins_medium)
        FontLoader.loadFontAsync(lifecycleScope, this, aboutButton, R.font.poppins_medium)
    }
